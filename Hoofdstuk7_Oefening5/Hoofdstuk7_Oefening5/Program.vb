...
Module Program
    ...
    Sub Main(args As String())
        Dim objJorisCusters As New AmateurWielrenner("Joris Custers", 25, "Wielerclub Evergem", 15, 3)
        objJorisCusters.ToonNaam()
        objJorisCusters.ToonLeeftijd()
        objJorisCusters.ToonPloeg()
        objJorisCusters.ToonAantalDeelnames()
        objJorisCusters.ToonAantalOverwinningen()
        Console.WriteLine()

        Dim objJanPersan As New AmateurWielrenner("Jan Persan", 30, "Wielerclub Evergem", 50, 13)
        objJanPersan.ToonNaam()
        objJanPersan.ToonLeeftijd()
        objJanPersan.ToonPloeg()
        objJanPersan.ToonAantalDeelnames()
        objJanPersan.ToonAantalOverwinningen()
        Console.WriteLine()

        Dim objWoutVanAert As New ProfWielrenner("Wout van Aert", 28, "Jumbo-Visma", 45, 4500000)
        objWoutVanAert.ToonNaam()
        objWoutVanAert.ToonLeeftijd()
        objWoutVanAert.ToonPloeg()
        objWoutVanAert.ToonAantalOverwinningen()
        objWoutVanAert.ToonSalaris()
    End Sub
End Module
